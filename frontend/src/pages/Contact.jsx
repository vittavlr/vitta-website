          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                ...
                <input required value={form.name} onChange={update('name')} className={`mt-1 w-full rounded-lg border bg-fawn/70 px-4 py-2.5 outline-none focus:border-gold ${fieldError('name') ? 'border-red-400' : 'border-bronze/20'}`} />
                {fieldError('name') && <p className="text-xs text-red-600 mt-1">Please enter your name.</p>}
              </div>
              <div>
                <label className="text-sm font-medium">Phone <span className="text-red-500">*</span></label>
                <input required type="tel" value={form.phone} onChange={update('phone')} className={`mt-1 w-full rounded-lg border bg-fawn/70 px-4 py-2.5 outline-none focus:border-gold ${fieldError('phone') ? 'border-red-400' : 'border-bronze/20'}`} />
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                ...
                <input type="email" value={form.email} onChange={update('email')} className="mt-1 w-full rounded-lg border border-bronze/20 bg-fawn/70 px-4 py-2.5 outline-none focus:border-gold" />
              ...
              <div>
                ...
                <select required value={form.service_interest} onChange={update('service_interest')} className={`mt-1 w-full rounded-lg border bg-fawn/70 px-4 py-2.5 outline-none focus:border-gold ${fieldError('service_interest') ? 'border-red-400' : 'border-bronze/20'}`}>
            ...
            <div>
              ...
              <textarea rows={5} value={form.message} onChange={update('message')} className="mt-1 w-full rounded-lg border border-bronze/20 bg-fawn/70 px-4 py-2.5 outline-none focus:border-gold" />
            </div>
